$(document).ready(function() {
    ...
    $('.owl-general .owl-carousel').owlCarousel({
        ...
        items: 1,
        navText: [
            '<img src="./img/arrow_forward.svg" alt="prev">',
            '<img src="./img/arrow_forward.svg" alt="next">'
        ],
     ...
     // Initialize Owl Carousel for the mission section
        $(document).ready(function(){
            if (typeof $.fn.owlCarousel === 'function') {
                $('.featured-carousel').owlCarousel({
                    ...
                    navText: ['<img src="img/arrow_back.svg" alt="prev">','<img src="img/arrow_back.svg" alt="next">']
                });
            } else {
                console.warn('Owl Carousel not loaded: include owl.carousel.min.js and owl.carousel.min.css');
            }
        });
